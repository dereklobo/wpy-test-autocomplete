var Autocomplete = (function() {
  ...
  return n(function t() {
    var n = this,
      ...
      k = o.onLoaded,
      U = void 0 === k ? function() {} : k,
      L = o.submitOnEnter,
      C = void 0 !== L && L
    e(this, t),
      s(this, 'value', ''),
      s(this, 'searchCounter', 0),
      s(this, 'results', []),
      s(this, 'selectedIndex', -1),
      s(this, 'selectedResult', null),
      ...
      s(this, 'handleInput', function(e) {
        var t = e.target.value
        n.updateResults(t), (n.value = t)
      }),
          ...
          case 'ArrowDown':
            var s =
              'ArrowUp' === t || 'Up' === t
                ? n.selectedIndex - 1
                : n.selectedIndex + 1
            e.preventDefault(), n.handleArrows(s)
            break
          case 'Tab':
            n.selectResult()
            break
          case 'Enter':
            var o = e.target.getAttribute('aria-activedescendant').length > 0
            ;(n.selectedResult =
      ...
      s(this, 'handleResultMouseDown', function(e) {
        e.preventDefault()
      }),
      s(this, 'handleResultClick', function(e) {
        var t = e.target,
          s = l(t, '[data-result-index]')
        if (s) {
          n.selectedIndex = parseInt(s.dataset.resultIndex, 10)
          var o = n.results[n.selectedIndex]
          n.selectResult(), n.onSubmit(o)
        }
      }),
      s(this, 'handleArrows', function(e) {
        var t = n.results.length
        ;(n.selectedIndex = ((e % t) + t) % t),
          n.onUpdate(n.results, n.selectedIndex)
      }),
      s(this, 'selectResult', function() {
        var e = n.results[n.selectedIndex]
        e && n.setValue(e), n.hideResults()
      }),
      s(this, 'updateResults', function(e) {
        var t = ++n.searchCounter
        n.onLoading(),
          n.search(e).then(function(e) {
            t === n.searchCounter &&
              ((n.results = e),
              n.onLoaded(),
              0 !== n.results.length
      ...
      s(this, 'checkSelectedResultVisible', function(e) {
        ...
        if (t) {
          ...
          o.top < s.top
            ? (e.scrollTop -= s.top - o.top)
            : o.bottom > s.bottom && (e.scrollTop += o.bottom - s.bottom)
        }
      }),
      (this.search = u(i)
        ? i
