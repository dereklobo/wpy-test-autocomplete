...
var AutocompleteCore = /*#__PURE__*/ _createClass(function AutocompleteCore() {
  ...
  var _ref =
    ...
    setAttribute =
      _ref$setAttribute === void 0 ? function() {} : _ref$setAttribute,
  ...
  _defineProperty(this, 'handleKeyDown', function(event) {
    ...
    switch (key) {
      ...
      case 'Enter': {
        var isListItemSelected =
          event.target.getAttribute('aria-activedescendant').length > 0
        _this.selectedResult =
          _this.results[_this.selectedIndex] || _this.selectedResult
        _this.selectResult()
  ...
  _defineProperty(this, 'checkSelectedResultVisible', function(resultsElement) {
    var selectedResultElement = resultsElement.querySelector(
      '[data-result-index="'.concat(_this.selectedIndex, '"]')
    )
...
var Autocomplete = /*#__PURE__*/ _createClass(
  function Autocomplete(root) {
    ...
    _defineProperty(this, 'initialize', function() {
      ...
      resultListAriaLabel &&
        _this2.resultList.setAttribute(
      ...
      if (!_this2.resultList.id) {
        _this2.resultList.id = uniqueId(
          ''.concat(_this2.baseClass, '-result-list-')
        )
      }
      ...
      _this2.resultList.addEventListener(
        'mousedown',
        _this2.core.handleResultMouseDown
      )
    ...
    _defineProperty(this, 'destroy', function() {
      ...
      _this2.resultList.removeEventListener(
        'mousedown',
        _this2.core.handleResultMouseDown
      )
      _this2.resultList.removeEventListener(
        'click',
        _this2.core.handleResultClick
      )
      _this2.root = null
      _this2.input = null
    ...
    _defineProperty(this, 'renderResult', function(result, props) {
      return '<li '
        .concat(props, '>')
        .concat(_this2.getResultValue(result), '</li>')
    })
    _defineProperty(this, 'handleUpdate', function(results, selectedIndex) {
      ...
      _this2.input.setAttribute(
        'aria-activedescendant',
        selectedIndex > -1
          ? ''.concat(_this2.baseClass, '-result-').concat(selectedIndex)
          : ''
      )
    ...
    _defineProperty(this, 'updateStyle', function() {
      ...
      _this2.resultList.style.visibility = _this2.expanded
        ? 'visible'
        : 'hidden'
